      ...
      <div className="bg-background min-h-screen flex flex-col">
        <header className="sticky top-0 z-40 px-3 py-2.5 flex items-center gap-3 bg-primary shadow-md">
          ...
          <div className="flex items-center gap-1">
            <button className="p-2 text-primary-foreground/80 hover:text-primary-foreground"><Video className="w-5 h-5" /></button>
            <button className="p-2 text-primary-foreground/80 hover:text-primary-foreground"><Phone className="w-5 h-5" /></button>
